...
における積の計算は, よく知られているように Leibniz rule で計算できる. 
すなわち, $2n$ 変数多項式環 
...
積の効率化が重要であり, そのためには Leibniz rule をどう使うかが鍵となる. 
...
として, 右辺の $D_i^{k_i}x_i^{a_i}$ を Leibniz rule により
...
Leibniz rule に現れる微分を $f\in K[x,\xi]$に作用させても monomial
...
\item 最後にそれらを足し合わせる. 
\end{enumerate}
要するに, Leibniz rule において, 微分に関する和を先に計算するというこ
